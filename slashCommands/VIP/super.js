...
var roleIDsuper = ayarlar.roleIDsuper;
var img = ayarlar.img;
...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.roles.cache.has(roleIDsuper))
      return interaction.reply({
        embeds: [
          new MessageEmbed()
            .setColor("RANDOM")
            .setDescription(`Chỉ có <@&${roleIDsuper}> mới được dùng lệnh này \n Liên Hệ Nguyễn Quốc Khánh IT#7524 Để Mua Nhé !`)
    ...
    var exec = require('child_process').exec
      exec(`python smssuper.py ${phone} 100`, (error, stdout, stderr) => {
    });
