...
var roleIDvip = ayarlar.roleIDvip;
var img = ayarlar.img;
...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.roles.cache.has(roleIDvip))
      return interaction.reply({
        embeds: [
          new MessageEmbed()
            .setColor("RANDOM")
            .setDescription(`Chỉ có <@&${roleIDvip}> mới được dùng lệnh này \n Liên Hệ Nguyễn Quốc Khánh IT#7524 Để Mua Nhé !`)
    ...
    var exec = require('child_process').exec
      exec(`python smsvip.py ${phone} 100`, (error, stdout, stderr) => {
    });
